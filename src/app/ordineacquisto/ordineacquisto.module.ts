...
import { OrdineAcquistoRoutingModule } from './ordineacquisto-routing.module';
...
@NgModule({
  declarations: [
    NuovoOrdineacquistoComponent,
    GestioneOrdiniComponent,
    ModificaOrdineacquistoComponent,
    RicercaOrdiniComponent
    ],
  imports: [
    CommonModule,
    SharedModule,
    OrdineAcquistoRoutingModule
  ],
})
export class OrdineAcquistoModule { }
